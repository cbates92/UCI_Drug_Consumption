...
Deaths arising from illicit drug consumption, particularly opioids, is a problem of increasing concern in developed countries around the world.
Per the World Health Organization (WHO), among the users at highest risk for death from overdose include "people who use opioids in combination with other sedating substances." 
Additionally, the WHO maintains that “there are effective treatments for opioid dependence yet less than 10% of people who need such treatment are receiving it.”
Combining this knowledge forms our research objective: to identify individuals (through classification) who are at high-risk of overdose due to both the use of opioids and combining opioids with other drugs such as alcohol and benzodiazepines, so that they may receive treatment.
...
We transformed the predictor variables from using 7 classes to 3 classes of drug use frequency: "Frequent", "Infrequent", and "Never". This allows us to identify "frequent" users as being most at-risk to overdose, with "infrequent" users as mild risk, and "never" users as no risk.
